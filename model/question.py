...
class Question:
    ...
    def set_question(self, question):
        ...
        # 问题设置疾病症状关键词
        self.__word_pos_list = WordParser.parse(self.__question)
        self.__word_list = WordParser.lcut(self.__question)
        self.__disease = [i[0] for i in self.__word_pos_list if i[1] == 'nobjectdisease']
        self.__medicine = [i[0] for i in self.__word_pos_list if i[1] == 'nobjectmedicine']
        self.__body = [i[0] for i in self.__word_pos_list if i[1] == 'nobjectbody']
        self.__question_key_words = [i[0] for i in self.__word_pos_list if i[1].startswith('rw')]
    ...
    # def init_idf(self):
    #     for evidence in self.__evidences:
    #         word_set = set(evidence.get_words())
