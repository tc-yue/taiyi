...
class QuestionAnsweringSystem:
    ...
    # 开放领域问题调用tuling api
    @staticmethod
    def tl_chat(question_str):
        args = {'key': '525ef6b3a42043c196e9df0d549bc68f', 'info': question_str}
    ...
    def ir_based_answer_question(self, question):
        ...
        for evidence in question.get_evidences():
            ...
            i += 1
            # p.apply_async(self.long_time_task,args=(question,evidence))
    ...
    def long_time_task(self, question, evidence):
        logging.debug('开始处理Evidence{}：{}'.format(evidence,os.getpid()))
        print('1')
        self.__evidence_score.score(question, evidence)
        print('2')
...
if __name__ == '__main__':
    ...
    qa.answer_question('晚上吃西瓜后，拉肚子怎么办')
