...
class EvidenceScore:
    def __init__(self, weight_list=(0.2, 0.1, 0.1)):
    ...
    def similarity_score(self,question1,evidence1):
        ...
        ss.combination_sim(question1, question_b)
        score = ss.get_score() * self.similarity_weight
...
if __name__ == '__main__':
    ...
    evidence = Evidence()
    evidence.set_title('早上起来就一直腹泻，还出血了，怎么办')
    evidence.set_snippet('建议你去医院治疗，腹泻这种情况还是要牙医治疗')
    evidence2 = Evidence()
    evidence2.set_title('早上起来就一直腹泻，还出血了，吃什么药')
    evidence2.set_snippet('建议你去医院治疗，腹泻这种情况还是要牙医治疗')
